...
describe("Products route test suite", function () {
    ...
    it("Should respond with a JSON containing and array of products", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    expect(JSON.stringify(response.body)).toEqual('[{"id":1,"name":"Name1","price":1,"category":"Category1","order_counter":"1"},{"id":2,"name":"Name2","price":2,"category":"Category2","order_counter":"2"}]');
                    return [2 /*return*/];
            }
        });
    }); });
    it("Should respond with a JSON containing one product with id 1", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    expect(JSON.stringify(response.body)).toEqual('{"id":1,"name":"Name1","price":1,"category":"Category1","order_counter":"1"}');
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it("Should respond with an array containing one order with the category as Category1", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
