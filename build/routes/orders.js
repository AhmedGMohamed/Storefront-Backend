...
var Orders = new order_1.OrderStore();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Orders.orderUser(user_id)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 3];
...
router.post("/", verifyAuthToken_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, result, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Orders.update(order)];
            case 1:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 3];
...
router.post("/product/:product_id", verifyAuthToken_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                orderStatus = (_a.sent()).status;
                if (orderStatus != "open") {
                    throw new Error("Could not add product ".concat(productOrder.product_id, " to order ").concat(productOrder.order_id, " because order status is ").concat(orderStatus));
                }
                return [4 /*yield*/, Orders.addProductOrder(productOrder)];
            case 2:
                result = _a.sent();
                res.json(result);
                return [3 /*break*/, 4];
            case 3:
                error_6 = _a.sent();
                res.status(400).json("".concat(error_6));
                return [3 /*break*/, 4];
